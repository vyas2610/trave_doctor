...
<body>
    ...
    <div id="page" class="page">
            ...
            <div class="header-wrapper">
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="#hero-4" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="#hero-4" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
        ...
        <section id="hero-4" class="hero-section division">
            <div class="slideshow">
                <div class="slideshow-inner">
                    ...
                    <div class="slides">
                        ...
                        <div class="slide is-active">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="caption white-color">
                                                ...
                                                <div class="text">
                                                    ...
                                                    <p class="p-md">Feugiat primis ligula risus auctor egestas augue
                                                        mauri viverra tortor in
                                                        iaculis placerat eugiat mauris ipsum in viverra tortor and
                            ...
                            <div class="image-container">
                                <img class="img-fluid1" src="images/slider/slide-11.jpg" alt="slide-background">
                            </div>
                    ...
                    <!-- SLIDER ARROWS -->
                    <div class="arrows icon-xs white-color">
                        <div class="arrow prev"><span class="flaticon-368-left-arrow-3"> </span></div>
                        <div class="arrow next"><span class="flaticon-367-right-arrow-3"> </span></div>
                    </div>
        ...
        <!-- SERVICES-2
			============================================= -->
        <section id="services-2" class="bg-lightgrey1 wide-60 services-section division">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="sbox-2 icon-sm">

                            <!-- Icon -->
                            <div class="sbox-2-icon"><span class="flaticon-431-bank"></span></div>
                            ...
                            <div class="sbox-2-txt">
                                ...
                                <p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
                                    a tempus feugiat dolor and lacinia blandit ligula posuere at feugiat
                                </p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="sbox-2 icon-sm">
                            ...
                            <!-- Icon -->
                            <div class="sbox-2-icon"><span class="flaticon-033-user-2"></span></div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="sbox-2 icon-sm">
                            ...
                            <!-- Icon -->
                            <div class="sbox-2-icon"><span class="flaticon-067-suitcase-1"></span></div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="sbox-2 icon-sm">
                            ...
                            <!-- Icon -->
                            <div class="sbox-2-icon"><span class="flaticon-286-earth-globe"></span></div>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="about-1-txt pc-20 mb-40">
                            ...
                            <!-- Section ID -->
                            <span class="section-id id-color">About VisaPRO</span>
                            ...
                            <!-- Text -->
                            <p>Cursus risus laoreet auctor, varius augue. Nulla dolor and sapien risus nec, luctus
                                mauris donec
                                diam sapien neque in cubilia an ligula quaerat ipsam volute turpis sodales sapien vitae
                                donec ipsum
                            </p>
        ...
        <!-- SERVICES-9
			============================================= -->
        <section id="services-9" class="bg-tra-map bg-lightgrey wide-100 services-section division">
            <div class="container">
                        ...
                        <div class="owl-carousel owl-theme owl-loaded services-carousel">
                            ...
                            <div class="sbox-9 sbox-9-color">
                                ...
                                <div class="sbox-9-txt">
                                    ...
                                    <!-- Title -->
                                    <h5 class="h5-lg darkblue-color">Canada</h5>

                                    <!-- Text -->
                                    <p class="p-sm">Cursus porta feugiat and primis ultrice ligula risus auctor, tempus
                                        a dolor
                                        feugiat felis lobortis
                                    </p>

                                    <!--Link -->
                                    <a href="country-details.html">Read More <i class="fas fa-caret-right"></i></a>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="request-txt white-color pc-20 mb-40">
                            ...
                            <h5 class="h5-md">Euismod risus auctor egestas augue mauri viverra euismod tortor eugiat a
                                mauris placerat</h5>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">What You Can Read Next</h2>
