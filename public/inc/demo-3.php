            ...
            <div class="header-wrapper">
                    ...
                    <div class="headerwp clearfix">
                        ...
                        <div class="headertopleft">
                            <div class="header-info clearfix">
                                <span class="txt-400"><i class="fas fa-map-marker-alt"></i>121 King St, Melbourne,
                                    Victoria 3000</span>
                            </div>
                        </div>
                        ...
                        <div class="headertopright header-contacts">
                            <a href="tel:123456789" class="callusbtn txt-400"><i class="fas fa-phone"></i>+61-2 3456
                                7890,</a>
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="#hero-3" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="#hero-3" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
                        ...
                        <nav class="wsmenu clearfix blue-header">
                            <ul class="wsmenu-list">
                                ...
                                <li class="nl-simple" aria-haspopup="true">
                                    <a href="contacts-1.html" class="header-btn btn-primary tra-black-hover last-link">Let's Started</a>
                                </li>
                    ...
                    <div class="col-lg-7 col-xl-7">
                        <div class="hero-3-txt mb-40">
                            ...
                            <div class="box-list">
                                ...
                                <p class="p-md">Fringilla risus nec, luctus mauris orci auctor purus
                                    euismod pretium purus at pretium ligula rutrum viverra tortor sapien sodales
                                </p>
                            </div>
                            ...
                            <div class="box-list">
                                <div class="box-list-icon"><i class="fas fa-genderless"></i></div>
                                <p class="p-md">Quaerat sodales sapien undo euismod risus auctor egestas
                                    augue mauri undo viverra tortor sapien sodales sapien vitae donec and ipsum
                                    porta justo integer at velna vitae auctor laoreet augue
                                </p>
                            </div>
                        ...
                        <div id="hero-form" class="text-center mb-40">
                            <form name="heroRequestForm" class="row hero-request-form bg-darkblue">
                                ...
                                <div class="col-md-12 form-btn">
                                    <button type="submit" class="btn btn-primary tra-white-hover submit">Send
                                        Request</button>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs darkblue-color">Travel Doctor Immigration Services</h2>
                        ...
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Education Visa</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <!-- Text -->
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Business Immigration</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <!-- Text -->
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Skilled Immigration</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <!-- Text -->
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Spouse/Family Visa</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <!-- Icon -->
                                <div class="sbox-4-icon primary-color"><span class="flaticon-067-suitcase-1"></span>
                                </div>

                                <!-- Text -->
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Tourist & Visitor Visa</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="visa-details.html">
                                ...
                                <!-- Icon -->
                                <div class="sbox-4-icon primary-color"><span class="flaticon-318-planet-earth"></span>
                                </div>

                                <!-- Text -->
                                <div class="sbox-4-txt">
                                    <h5 class="h5-md darkblue-color">Language Courses</h5>
                                    <p>Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat
                                    </p>
                                </div>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="about-2-txt pc-20 mb-40">
                            ...
                            <div class="box-list">
                                <div class="box-list-icon"><i class="fas fa-genderless"></i></div>
                                <p>Quaerat sodales sapien undo euismod purus and blandit laoreet augue an augue egestas.
                                    Augue
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-7 col-xl-6">
                        <div class="about-4-txt mb-40">
                            ...
                            <!-- Title -->
                            <h3 class="h3-lg darkblue-color">We provide the best consulting services in the industry
                                since 2009</h3>
                            ...
                            <div class="box-list">
                                <div class="box-list-icon"><i class="fas fa-genderless"></i></div>
                                <p>Quaerat sodales sapien undo euismod risus auctor egestas augue mauri undo viverra
                                    tortor
                                    sapien sodales sapien and vitae donec gravida donec enim blandit ipsum at porta
                                    justo integer
                                </p>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center white-color">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">Why Choose Travel Doctor?</h2>
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="txt-block pc-20 mb-40">
                                            ...
                                            <!-- Title -->
                                            <h3 class="h3-lg darkblue-color">Thousands of people choose our services
                                            </h3>
                                ...
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="txt-block pc-20 mb-40">
                                            ...
                                            <!-- Title -->
                                            <h3 class="h3-lg darkblue-color">Get guarantee success with our advisors
                                            </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <!-- Text -->
                            <p class="p-sm">An magnis nulla dolor sapien augue erat iaculis purus tempor and magna
                                pretium
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">Canadian efficitur ipsum at primis cubilia a laoreet vitae lobortis
                                        iaculis purus <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">Canada efficitur an ultrice sapien augue <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">Canada dolor primis and sapien <i class="fas fa-caret-right"></i></a>
                                </li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">Australian at sodales and ultrice sapien <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">Australia efficitur vitae lobortis ipsum at primis cubilia a laoreet
                                        iaculis purus <i class="fas fa-caret-right"></i></a></li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">UK dolor magna ultrice undo augue <i class="fas fa-caret-right"></i></a>
                                </li>

                                <li><a href="#">UK vitae lobortis magna ipsum at primis cubilia a laoreet iaculis purus
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">New Zealand efficitur ipsum primis sodales vitae lobortis cubilia an
                                        iaculis purus <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">New Zealand dolor at sapien augue <i class="fas fa-caret-right"></i></a>
                                </li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">Singapore augue erat sodales vitae <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">Singapore efficitur ipsum at primis sodales vitae lobortis cubilia and
                                        laoreet <i class="fas fa-caret-right"></i></a></li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="cbox-2">
                            ...
                            <ul class="links-list darkblue-color">
                                ...
                                <li><a href="#">US dolor ultrice vitae lobortis augue <i class="fas fa-caret-right"></i></a></li>

                                <li><a href="#">US efficitur ipsum at primis sodales vitae lobortis cubilia a laoreet
                                        iaculis purus <i class="fas fa-caret-right"></i></a></li>
            ...
            <div class="container">
                        ...
                        <div id="accordion" role="tablist">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingOne">
                                    <h5 class="h5-sm darkblue-color">
                                        <a data-bs-toggle="collapse" href="#collapseOne" role="button" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingTwo">
                                    <h5 class="h5-sm darkblue-color">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false" aria-controls="collapseTwo">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingThree">
                                    <h5 class="h5-sm darkblue-color">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false" aria-controls="collapseThree">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingFour">
                                    <h5 class="h5-sm darkblue-color">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false" aria-controls="collapseFour">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header" role="tab" id="headingFive">
                                    <h5 class="h5-sm darkblue-color">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false" aria-controls="collapseFive">
                ...
                <div class="row">
                    <div class="col-md-12 text-center more-questions">
                        <h5 class="h5-md">Still have a question? <a href="./?page=faqs" class="darkblue-color">Ask your
                                question here</a></h5>
                    </div>
                </div>
            ...
            <div class="container white-color">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        <div class="footer-info mb-40">
                            ...
                            <!-- Text -->
                            <p class="p-sm mt-25">Aliquam orci a nullam tempor undo sapien donec gravida an enim ipsum
                                porta
                ...
                <div class="bottom-footer">
                    <div class="row d-flex align-items-center">
                        ...
                        <!-- FOOTER COPYRIGHT -->
                        <div class="col-lg-6">
                            <p class="footer-copyright">&copy; Copyright <span>Travel Doctor 2019</span>. All Rights Reserved
                            </p>
                        </div>
