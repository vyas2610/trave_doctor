			...
			<div class="header-wrapper">
				...
				<div class="wsmainfull menu clearfix">
					<div class="wsmainwp clearfix">
						...
						<div class="desktoplogo"><a href="#hero-8" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
						<div class="desktoplogo"><a href="#hero-8" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
								...
								<div class="row">
									<div class="col-md-8 col-lg-6">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h2 class="primary-color">Study Abroad</h2>

											<!-- Text -->
											<h4 class="h4-md darkblue-color">
												We are your pathfinder at each step of <span>Abroad Education Process</span>
											</h4>
								...
								<div class="row">
									<div class="col-md-8 col-lg-6">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h2 class="primary-color">Tourist Visa</h2>

											<!-- Text -->
											<h4 class="h4-md darkblue-color">
												Travel is only thing you buy that <span>Makes You Richer</span>
											</h4>
								...
								<div class="row">
									<div class="col-md-8 col-lg-6">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h2 class="primary-color">Permanent Residency Visa</h2>

											<!-- Text -->
											<h4 class="h4-md darkblue-color">
												Make your dream come true to settle permanently in <span>Your Dream Country</span>
											</h4>
								...
								<div class="row">
									<div class="col-md-8 col-lg-6">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h2 class="primary-color">Other Visas</h2>

											<!-- Text -->
											<h4 class="h4-md darkblue-color">
												Just change your location and you will <span>Change Yourself Forever</span>
											</h4>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 section-title center">
						...
						<!-- Title -->
						<h2 class="h2-xs darkblue-color">What You Can Read Next</h2>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-xl-3">
						<div class="footer-links mb-40">
							...
							<!-- Title -->
							<h5 class="h5-md darkblue-color">Visas</h5>
