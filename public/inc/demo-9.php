            ...
            <div class="header-wrapper">
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="#hero-9" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="#hero-9" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
                    ...
                    <div id="hero-9-content" class="row">
                        <div class="col-lg-10 offset-lg-1 hero-txt text-center">
                            ...
                            <p class="p-md">Feugiat primis ligula risus auctor egestas augue mauri viverra tortor in
                                iaculis
                                and placerat purus feugiat primis ultrice in ligula impedit magna purus pretium neque
                                ligula
                                an ipsam volute turpis quaerat auctor and rhoncus laoreet augue in cubilia augue
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="about-1-txt pc-20 mb-40">
                            ...
                            <p>Cursus risus laoreet auctor, varius augue. Nulla dolor and sapien risus nec, luctus
                                mauris
                                donec diam sapien neque in cubilia an ligula quaerat ipsam volute turpis sodales sapien
                                vitae donec
                                an ipsum porta justo integer at velna vitae auctor a magna risus
                            </p>

                            <!-- Button -->
                            <a href="#" class="btn btn-md btn-tra-grey black-hover btn-arrow">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-8 col-lg-7 offset-md-4 offset-lg-5">
                        <div class="cta-txt">
                            ...
                            <!-- Button  -->
                            <a href="mailto:youremail@mail.com" class="btn btn-md btn-tra-white primary-hover btn-arrow">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">Our Partner Institutions</h2>
