			...
			<div class="header-wrapper">
					...
					<div class="headerwp clearfix">
						...
						<div class="headertopleft">
							<div class="header-info clearfix">
								<span class="txt-400"><i class="fas fa-map-marker-alt"></i>114 , 1st Floor Jodhpur Tower Main Road Paota Jodhpur , Rajasthan (342006)</span>
							</div>
						</div>
						...
						<div class="headertopright header-contacts">
							...
							<a href="mailto:yourdomain@mail.com" class="yellow-color txt-400"><i class="far fa-envelope-open"></i>info@travelsdoctor.com</a>
						</div>
				...
				<div class="wsmainfull menu clearfix">
					<div class="wsmainwp clearfix">
						...
						<div class="desktoplogo"><a href="#hero-2" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
						<div class="desktoplogo"><a href="#hero-2" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
							...
							<ul class="wsmenu-list">
								...
								<li aria-haspopup="true"><a href="#">Home <span class="wsarrow"></span></a>
									<ul class="sub-menu">
										...
										<li aria-haspopup="true"><a href="demo-3.html">Homepage-3</a></li>
								...
								<div class="row">
									<div class="col-md-9 col-lg-7">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h3>Study in</h3>
											<h2 class="darkblue-color">Australia</h2>

											<!-- Text -->
											<h4 class="h4-md">Tavel & Tourism, Engineering, Business, Health, Science, IT and many more...</h4>
								...
								<div class="row">
									<div class="col-md-9 col-lg-7">
										<div class="caption-txt white-color">
											...
											<!-- Text -->
											<h4 class="h4-md">Canberra, Sydney, Adelaide, Gold Coast, Brisbane, Darwin, Melbourne, Perth</h4>
								...
								<div class="row">
									<div class="col-md-10 col-lg-8">
										<div class="caption-txt">
											...
											<!-- Title -->
											<h3>No IELTS</h3>
											<h2 class="darkblue-color">No Interview</h2>

											<!-- Text -->
											<h4 class="h4-md">Top Ranked Universities, No Age Limit, Low Living Cost, Work Allowed and many more...</h4>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-4">
							<div class="abox-3 icon-sm">
								...
								<!-- Icon -->
								<div class="abox-3-icon primary-color"><span class="flaticon-375-checked"></span></div>

								<!-- Text -->
								<div class="abox-3-txt">

									<h5 class="h5-md darkblue-color">Overseas Education and Study Visa Consultants</h5>
						...
						<div class="col-lg-4">
							<div class="abox-3 icon-sm">
								...
								<!-- Icon -->
								<div class="abox-3-icon primary-color"><span class="flaticon-431-bank"></span></div>

								<!-- Text -->
								<div class="abox-3-txt">

									<h5 class="h5-md darkblue-color">Guaranteed Admission in Top Ranked Universities</h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice and ligula risus auctor
										tempus feugiat dolor and lacinia
									</p>
						...
						<div class="col-lg-4">
							<div class="abox-3 icon-sm">
								...
								<!-- Icon -->
								<div class="abox-3-icon primary-color"><span class="flaticon-141-invoice"></span></div>

								<!-- Text -->
								<div class="abox-3-txt">

									<h5 class="h5-md darkblue-color">No IELTS Required for Australian Study Visa</h5>
									<!-- Text -->
									<p>Porta semper lacus cursus, feugiat primis ultrice and ligula risus auctor
										tempus feugiat dolor and lacinia
									</p>
				...
				<div class="row d-flex align-items-center">
					...
					<div class="col-md-6">
						<div class="about-img text-center mb-40">
							<img class="img-fluid" src="images/image-05.png" alt="about-image" />
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="about-2-txt pc-20 mb-40">
							...
							<!-- Title -->
							<h3 class="h3-lg darkblue-color">Consultations for prospective students</h3>

							<!-- Text #1 -->
							<div class="box-list">
								<div class="box-list-icon"><i class="fas fa-genderless"></i></div>
								<p>An magnis nulla dolor sapien augue erat iaculis purus tempor magna ipsum vitae purus primis
									pretium ligula rutrum luctus blandit porta justo integer. Feugiat a primis ultrice ligula
								</p>
							</div>
							...
							<div class="box-list">
								...
								<p>Nemo ipsam egestas volute turpis dolores and aliquam quaerat sodales sapien undo pretium
									purus ligula a tempus ipsum undo auctor a mauris lectus ipsum blandit egestas magna ligula
								</p>
							</div>
				...
				<div class="row d-flex align-items-center">
							...
							<div class="col-sm-6">
								<div class="about-5-txt mb-40">
									...
									<ul class="abox-list">
										...
										<li><a href="#">Overseas Internship</a></li>
					...
					<div class="col-lg-7">
						<div class="about-5-img text-center mb-40">
							<img class="img-fluid" src="images/australia.png" alt="about-image" />
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 section-title center">
						...
						<!-- Title -->
						<h2 class="h2-xs darkblue-color">Travel Doctor Education Services</h2>
				...
				<div class="row d-flex align-items-center">
					...
					<div id="sb-01" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">University Selection</h5>
					...
					<div id="sb-02" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">Visa Assistance</h5>
							<p class="p-sm">Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat</p>
					...
					<div id="sb-03" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">Coaching Centers</h5>
							<p class="p-sm">Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat</p>
					...
					<div id="sb-04" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">Overseas Internship</h5>
							<p class="p-sm">Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat</p>
					...
					<div id="sb-05" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">Health Insurance</h5>
							<p class="p-sm">Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat</p>
					...
					<div id="sb-06" class="col-md-6 col-lg-4 sb-box">
						<div class="sbox-6">
							...
							<!-- Text -->
							<h5 class="h5-lg darkblue-color">Travel Assistance</h5>
							<p class="p-sm">Porta semper lacus cursus a feugiat primis an ultrice dolor undo congue placerat</p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 section-title center">
						...
						<!-- Title -->
						<h2 class="h2-xs darkblue-color">Our Most Popular Courses</h2>
						...
						<div class="owl-carousel owl-theme owl-loaded services-carousel">
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">General English</h5>
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">Fundamentals of English Grammar</h5>
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">Academic Writing</h5>
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">English for Career Development</h5>
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">IELTS Course</h5>
							...
							<div class="sbox-9 sbox-9-color">
								...
								<div class="sbox-9-txt">
									...
									<!-- Title -->
									<h5 class="h5-lg darkblue-color">English Grammar and Punctuation</h5>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 section-title center">
						...
						<!-- Title -->
						<h2 class="h2-xs darkblue-color">Our Partner Institutions</h2>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 section-title center">
						...
						<!-- Title -->
						<h2 class="h2-xs darkblue-color">Students Share Their Stories...</h2>
			...
			<div class="container white-color">
				...
				<div class="bottom-footer">
					<div class="row d-flex align-items-center">
						...
						<!-- FOOTER COPYRIGHT -->
						<div class="col-lg-6">
							<p class="footer-copyright">&copy; Copyright <span>Travel Doctor 2019</span>. All Rights Reserved</p>
						</div>
