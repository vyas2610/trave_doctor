            ...
            <div class="header-wrapper">
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="#hero-5" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="#hero-5" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
                        ...
                        <nav class="wsmenu clearfix blue-header">
                            <ul class="wsmenu-list">
                                ...
                                <li class="nl-simple" aria-haspopup="true">
                                    <a href="tel:123456789" class="header-btn btn-primary tra-black-hover last-link">
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        ...
                        <div class="hero-5-txt text-center white-color">
                            ...
                            <h2>Travel and Immigrate with Travel Doctor</h2>

                            <!-- Text -->
                            <p class="p-md">Nemo ipsam egestas volute turpis dolores aliquam quaerat sodales sapien undo
                                pretium purus ligula tempus ipsum undo auctor mauris Quaerat sodales a sapien undo
                                euismod
                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="about-8-txt bg-darkblue white-color">
                            ...
                            <!-- Section ID -->
                            <span class="section-id id-color">Planning to the Future</span>
                            ...
                            <p>An magnis nulla dolor sapien augue erat iaculis a purus tempor magna ipsum vitae purus
                                ...
                                ligula. Nemo ipsam egestas volute turpis dolores and aliquam quaerat sodales sapien undo
                                pretium
                            </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs darkblue-color">Our Success Stories...</h2>
