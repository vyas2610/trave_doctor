                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb white-color">
                                    ...
                                    <li class="breadcrumb-item"><a href="couching-list.html">All Courses</a></li>
                            ...
                            <div class="about-9-txt mb-40 pe-15">
                                ...
                                <div class="a-9-boxes row bg-lightgrey d-flex align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <div class="a9-box icon-xs">
                                            ...
                                            <!-- Icon -->
                                            <div class="a9-icon grey-color"><span class="flaticon-360-clipboard"></span>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- Text -->
                                        <p>Quisque laoreet turpis urna augue, viverra a augue eget, dictum tempor diam
                                            vehicula
                                            vel imperdiet varius viverra massa lorem. Fusce eu cursus nulla vitae massa
                                            dictum
                                        </p>
                        ...
                        <aside id="sidebar" class="col-lg-4">
                            ...
                            <div class="blog-categories sidebar-div mb-50">
                                ...
                                <ul class="blog-category-list clearfix">
                                    ...
                                    <li><a href="#" class="txt-400"><i class="fas fa-angle-double-right primary-color"></i> PTE Coaching</a>
                                    </li>
                                    <li><a href="#" class="txt-400"><i class="fas fa-angle-double-right primary-color"></i> SAT (Scholastic
                                            Aptitude Test)</a></li>
                                    <li><a href="#" class="txt-400"><i class="fas fa-angle-double-right primary-color"></i> OET (Occupational
                                            English Test)</a></li>
                                    <li><a href="#" class="txt-400"><i class="fas fa-angle-double-right primary-color"></i> Spoken English</a>
                                    </li>
                                </ul>
