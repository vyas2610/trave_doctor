        ...
        <header id="header-2" class="header blue-menu">
            <div class="header-wrapper">
                ...
                <div class="wsmobileheader clearfix">
                    ...
                    <span class="smllogo smllogo-black"><img src="images/logo-black.png" width="200" height="50" alt="mobile-logo" /></span>
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="#hero-6" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="#hero-6" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
                        ...
                        <nav class="wsmenu clearfix blue-header">
                            <ul class="wsmenu-list">
                                ...
                                <li class="nl-simple" aria-haspopup="true">
                                    <a href="tel:123456789" class="header-btn btn-primary tra-white-hover last-link">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 section-title center">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">Travel Doctor Immigration Services</h2>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="sbox-4 icon-sm">
                            <a href="courses-list.html">
                                ...
                                <!-- Icon -->
                                <div class="sbox-4-icon grey-color"><span class="flaticon-318-planet-earth"></span>
                                </div>
