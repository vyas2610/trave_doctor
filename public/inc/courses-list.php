            ...
            <div class="header-wrapper">
                ...
                <div class="wsmainfull menu clearfix">
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo"><a href="demo-1.html" class="logo-black"><img src="images/logo-black.png" width="180" height="45" alt="header-logo"></a></div>
                        <div class="desktoplogo"><a href="demo-1.html" class="logo-white"><img src="images/logo-white.png" width="180" height="45" alt="header-logo"></a></div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="sbox-7 sbox-color">
                                ...
                                <div class="sbox-7-txt bg-1 white-color">
                                    ...
                                    <!-- Text -->
                                    <p class="p-sm">Cursus porta feugiat primis ultrice and ligula risus auctor tempus a
                                        dolor feugiat,
                                        felis and lacinia a risus egestas sodales lobortis
                                    </p>

                                    <!--Link -->
                                    <a href="course-details.html" class="btn btn-sm btn-tra-white primary-hover">Read
                                        More</a>
                            ...
                            <div class="owl-carousel owl-theme owl-loaded services-carousel">
                                ...
                                <div class="sbox-9 sbox-9-color">
                                    ...
                                    <div class="sbox-9-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-sm">Cursus porta feugiat and primis ultrice ligula risus auctor,
                                            tempus a dolor
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="box-list">
                                                ...
                                                <p>An magnis nulla dolor sapien augue erat iaculis purus tempor magna
                                                    ipsum vitae purus
                                                    primis pretium ligula rutrum luctus blandit porta justo integer.
                                                    Feugiat a primis ultrice
                                    ...
                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <p>Maecenas gravida porttitor nunc, quis vehicula magna luctus tempor.
                                                Quisque vel laoreet
                                                turpis. Urna augue, viverra a augue eget, dictum tempor diam. Sed
                                                pulvinar consectetur
                                                nibh, vel imperdiet dui varius viverra. Pellentesque ac massa lorem.
                                                Fusce eu cursus est.
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" role="tab" id="headingThree">
                                        <h5 class="h5-sm">
                                            <a class="collapsed" data-bs-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false" aria-controls="collapseThree">
                                                <span>3.</span> What are the best free online diploma courses in
                                                English?
                                            </a>
                                        </h5>
                                    </div>
                                    ...
                                    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <div class="box-list">
                                                <div class="box-list-icon"><i class="fas fa-genderless"></i></div>
                                                <p>Quaerat sodales sapien undo euismod purus blandit laoreet augue an
                                                    augue egestas. Augue
                                    ...
                                    <div class="card-header" role="tab" id="headingFour">
                                        <h5 class="h5-sm">
                                            <a class="collapsed" data-bs-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false" aria-controls="collapseFour">
                                                <span>4.</span> What are the best free online certificate courses in
                                                English?
                                            </a>
                                        </h5>
                                    </div>
                                    ...
                                    <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <p>Curabitur ac dapibus libero. Quisque eu tristique neque. Phasellus
                                                blandit tristique justo
                                                ut aliquam. Aliquam vitae molestie nunc. Quisque sapien justo, aliquet
                                                non molestie sed purus,
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about-6-txt pc-20">
                                ...
                                <!-- Text -->
                                <p class="p-md">Fringilla risus luctus mauris auctor purus euismod pretium purus at
                                    pretium
                                    ligula rutrum viverra tortor sapien sodales quaerat sodales sapien blandit dolores
                                    and aliquam
                                </p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div class="footer-box mb-40">
                                ...
                                <!-- Email -->
                                <p class="p-sm foo-email">Email: <a href="mailto:yourdomain@mail.com">hello@demo.com</a>
                                </p>
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div class="footer-links mb-40">
                                ...
                                <ul class="foo-links clearfix">
                                    ...
                                    <li><a href="#">How Travel Doctor Works</a></li>
                        ...
                        <div class="col-lg-4 col-xl-3">
                            <div class="footer-links mb-40">
                                ...
                                <!-- Footer Links -->
                                <ul class="foo-links clearfix">
                                    <li><a href="#">About Travel Doctor Courses</a></li>
                    ...
                    <div class="bottom-footer">
                        <div class="row d-flex align-items-center">
                            ...
                            <!-- FOOTER COPYRIGHT -->
                            <div class="col-lg-6">
                                <p class="footer-copyright">&copy; Copyright <span>Travel Doctor 2019</span>. All Rights
                                    Reserved</p>
                            </div>
